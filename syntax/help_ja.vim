...
syn match helpVim		"\<Vim バージョン [0-9][0-9.a-z]*"
syn match helpVim		"^\s\+\zsVIM - メインヘルプファイル$"
syn region helpVim		start="^\s\+VIM リファレンス" end="^$"
syn region helpVim		start="^\s\+VIM ユーザーマニュアル" end="^$"
